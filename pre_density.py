...
if(len(params)==1):
    ...
    plt.text(-L/2+2,L-4,"t = "+str("{:.2f}".format(t))+"s",fontsize=14,color="white")
    plt.hist2d(x,y,bins=[[i for i in range(int(-L/2),int(L/2 +1))],[i for i in range(int(L+1))]],cmap=my_cmap,vmin=0,vmax=9.999)
